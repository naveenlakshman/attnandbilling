"""Phase 4 CRM and Student Identity multi-tenant isolation tests against Docker MySQL."""
...
os.environ["MYSQL_USER"] = "attn_app"
os.environ["MYSQL_PASSWORD"] = "admin210499"
os.environ["MYSQL_DB"] = "attn_billing_testing"
    ...
    try:
        ...
        cur.execute(
            """INSERT INTO institutes
               ...
               VALUES (%s, %s, %s, 'active', 'Asia/Kolkata', 'en-IN', 'INR', %s, %s)""",
        ...
        cur.execute(
            """INSERT INTO institute_domains
               ...
               VALUES (%s, %s, 'platform', 1, 'active', %s, %s, %s)""",
        ...
        cur.execute(
            """INSERT INTO institute_branding
               ...
               VALUES (%s, %s, %s, %s, '#112233', '#445566', %s, %s)""",
        ...
        cur.execute(
            """INSERT INTO branches
               ...
               VALUES (%s, %s, %s, 1, 10, %s)""",
            (inst_id, f"{label} Main Branch", f"MB{TOKEN[:4]}", now),
        )
        ...
        cur.execute(
            """INSERT INTO users
               ...
               VALUES (%s, %s, %s, %s, 'admin', %s, 1, 1, %s, %s)""",
        ...
        cur.execute(
            """INSERT INTO institute_memberships
               ...
               VALUES (%s, %s, 'institute_admin', 1, %s, %s)""",
...
def cleanup_test_data(inst_a_id, inst_b_id):
    ...
    try:
        ...
        for tbl in ["student_uploaded_documents", "student_profile_update_requests", "student_notes", "followups", "leads", "students", "institute_memberships", "users", "branches", "institute_branding", "institute_domains", "institutes"]:
            try:
                cur.execute(f"DELETE FROM {tbl} WHERE institute_id IN (%s, %s)", inst_ids)
...
def main():
    ...
    print(f"[*] Created Institute A on MySQL (ID: {inst_a_id}, Host: {HOST_A})")
    print(f"[*] Created Institute B on MySQL (ID: {inst_b_id}, Host: {HOST_B})")
    ...
    try:
        ...
        cur.execute(
            """INSERT INTO students
               ...
               VALUES (%s, 'STU001', 'Alice InstA', '9876543210', '2026-07-24', 'active', %s, %s, 1, %s, %s)""",
            (inst_a_id, branch_a_id, generate_password_hash("StudentA@123"), now, now),
        )
        student_a_id = cur.lastrowid

        cur.execute(
            """INSERT INTO students
               (institute_id, student_code, full_name, phone, joined_date, status, branch_id, password_hash, portal_enabled, created_at, updated_at)
               VALUES (%s, 'STU001', 'Bob InstB', '9876543210', '2026-07-24', 'active', %s, %s, 1, %s, %s)""",
            (inst_b_id, branch_b_id, generate_password_hash("StudentB@123"), now, now),
        )
        student_b_id = cur.lastrowid
        conn.commit()
        conn.close()

        print("[+] Test 1 PASSED: Created composite unique student_code STU001 in both institutes in MySQL.")
        ...
        cur.execute(
            """INSERT INTO leads
               ...
               VALUES (%s, 'Lead Alpha', '9988776655', '9988776655', 'New Lead', 'active', %s, %s, %s, %s)""",
        ...
        cur.execute(
            """INSERT INTO leads
               (institute_id, name, phone, whatsapp, stage, status, branch_id, assigned_to_id, created_at, updated_at)
               VALUES (%s, 'Lead Beta', '9988776655', '9988776655', 'New Lead', 'active', %s, %s, %s, %s)""",
        ...
        print("\n==================================================")
        print("ALL MULTI-INSTITUTE PHASE 4 MYSQL TESTS PASSED!")
        print("==================================================\n")
